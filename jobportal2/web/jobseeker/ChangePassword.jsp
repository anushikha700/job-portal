                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="white-box">
                            ...
                            <form method="post" class="form-horizontal form-material" action="../JsController?op=changePass&jsid=<%=jsid%>" onsubmit="return comparePwds(newpassword.value,rnewpassword.value);">
                                    <center>
