            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <form enctype="multipart/form-data" action="../JsController?op=add2&jsid=<%=jobseeker.getJsid()%>" method="post"class="form-horizontal form-material" >
                            <div class="form-group">

                                <div class="col-md-6">
                                    <img src="../assets/images/notavailable.png" style="width:200px;height: 200px" class="img" id="pic"/><br/>
                                    <input type="file" name="photo" id="photoInput" class="form-control"  onchange="readURL(this);" /> </div>   
                            </div>
