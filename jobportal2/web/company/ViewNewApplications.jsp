<%-- 
    Document   : CandidatesApplied2
    Created on : May 13, 2020, 5:29:38 PM
    Author     : anushikha
--%>
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">New Applications</h4>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="white-box">
                            ...
                            <h4 class="box-title">Candidates Applied </h4>
                           ...
                           <h4><p class="text-muted"> <code>For Job Title: <%=title%></code></p></h4>
                            <div class="table-responsive">
                               ...
                               <%if(listempty==true){%>
                                    <h4> No New applications for this job.</h4>
                                     <%}
                                     else{%>
                                    <thead>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td><%=jobapply.getApplicationDate()%>
                                             ...
                                             <td>
                                                 ...
                                                 <a href="../JobApplyController?op=ShortlistCandidate&jaid=<%=jaid%>&shortlist=approved&jid=<%=jid%>&title=<%=title%>"
                                                   
                                                    class="btn btn btn-rounded btn-default btn-outline m-r-5">
                                                     <i class="ti-check text-success m-r-5"></i>  Approve
                                                 </a>
                                                    
                                                 <a href="../JobApplyController?op=ShortlistCandidate&jaid=<%=jaid%>&shortlist=rejected&jid=<%=jid%>&title=<%=title%>"
