...
public final class login_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\n");
      out.write("<head>\n");
      out.write("\t<title>Want To Hire| Login</title>\n");
 ...
 if (request.getParameter("msg")!=null)
      ...
      out.write("\t\t\t\t\t\t\t\t<input type=\"email\" name=\"email\" placeholder=\"Email\" required=\"required\"  onfocus=\"s1.innerHTML='';\" autocomplete=\"off\" value=\"");
      out.print(email);
      out.write("\">\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t<div class=\"form-input\">\n");
      out.write("\t\t\t\t\t\t\t\t<label>Password</label>\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"password\" name=\"password\" placeholder=\"Password\" required=\"required\" value=\"");
      out.print(password);
      out.write("\">\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\n");
