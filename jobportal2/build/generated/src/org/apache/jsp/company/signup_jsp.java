...
public final class signup_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\n");
      out.write("                ajax.open(\"GET\", \"../CompanyController?op=varify&email=\" + x, true);\n");
      out.write(" \n");
      out.write("               ajax.send();\n");
      out.write("\n");
      ...
      out.write("                                                </span>\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("                                    <form action=\"..\\CompanyController?op=add\" method=\"post\" class=\"signin-form\" onsubmit=\"return comparePwds(password.value,rpassword.value);\">\n");
      out.write("\t\t\t\t\t\n");
      out.write("\t\t\t\t\t\t\t<div class=\"form-input\">\n");
      out.write("\t\t\t\t\t\t\t\t<label>Company Name</label>\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"text\" name=\"cname\" placeholder=\"\" value=\"");
      ...
      out.write("\" required=\"required\" autocomplete=\"off\" onblur=\"varifyEmailid(this.value, s2);\"/>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t<div class=\"form-input\">\n");
      out.write("\t\t\t\t\t\t\t\t<label>Password</label>\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"password\" name=\"password\" placeholder=\"\" value=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${company.password}", java.lang.String.class, (PageContext)_jspx_page_context, null));
