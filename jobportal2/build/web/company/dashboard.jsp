<%-- 
    Document   : dashboard
    Created on : Apr 18, 2020, 7:25:39 PM
    Author     : anushikha
--%>
...
<body class="fix-header">
                        ...
                        <div class="white-box">
                            ...
                            <div class="comment-center p-t-10">
                                <div class="comment-body">
                                    <div class="user-img"> <img src="../Main_template/plugins/images/users/pawandeep.jpg" alt="user" class="img-circle">
                                    </div>
                                ...
                                <div class="comment-body">
                                    <div class="user-img"> <img src="../Main_template/plugins/images/users/sonu.jpg" alt="user" class="img-circle">
                                    </div>
                                    <div class="mail-contnet">
                                ...
                                <div class="comment-body b-none">
                                    <div class="user-img"> <img src="../Main_template/plugins/images/users/arijit.jpg" alt="user" class="img-circle">
                                    </div>
                                    <div class="mail-contnet">
    ...
    <!--Counter js -->
    <script src="../Main_template/plugins/bower_components/waypoints/lib/jquery.waypoints.js"></script>
    <script src="../Main_template/plugins/bower_components/counterup/jquery.counterup.min.js"></script>
    <!-- chartist chart -->
    <script src="../Main_template/plugins/bower_components/chartist-js/dist/chartist.min.js"></script>
    <script src="../Main_template/plugins/bower_components/chartist-plugin-tooltip-master/dist/chartist-plugin-tooltip.min.js"></script>
    <!-- Sparkline chart JavaScript -->
    <script src="../Main_template/plugins/bower_components/jquery-sparkline/jquery.sparkline.min.js"></script>
    <!-- Custom Theme JavaScript -->
    <script src="../Main_template/html/js/custom.min.js"></script>
    <script src="../Main_template/html/js/dashboard1.js"></script>
    <script src="../Main_template/plugins/bower_components/toast-master/js/jquery.toast.js"></script>
</body>
